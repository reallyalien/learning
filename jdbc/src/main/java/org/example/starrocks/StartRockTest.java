...
//                    "group by a.TASK_ID;";
//            String sql="select * from iceberg_catalog_122.iceberg_test.audit_project_160w limit 10;";
            String sql="\n" +
                    "CREATE\n" +
                    "MATERIALIZED VIEW iceberg_catalog_122.iceberg_test.count_audit_project_160w\n" +
