...
public class CuratorTest1 {
    ...
    //连接超时时间
    private static final int CONNECTION_TIMEOUT = 3 * 100;

    //ZooKeeper服务地址
    private static final String CONNECT_ADDR = "192.168.100.187:2181,192.168.100.188:2181,192.168.100.190:2181";
    ...
    public static void main(String[] args) throws Exception {
        ...
        //创建永久节点
        client.create().forPath("/a/c", "/curator data".getBytes());
        //创建永久有序节点
...
//        client.create().withMode(CreateMode.EPHEMERAL).forPath("/curator/ephemeral", "/curator/ephemeral data".getBytes());
        //创建临时有序节点
        String s = client.create().withMode(CreateMode.EPHEMERAL_SEQUENTIAL).forPath("/curator/");
//        client.create().withProtection().withMode(CreateMode.EPHEMERAL_SEQUENTIAL).forPath("/curator/ephemeral_path2", "/curator/ephemeral_path2 data".getBytes());
        ...
        List<String> list = client.getChildren().forPath("/curator");
