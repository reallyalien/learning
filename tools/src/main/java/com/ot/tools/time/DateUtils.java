...
public class DateUtils {
	...
	public static void main(String[] args) {
		System.out.println(getMonthBefore(1));
	...
	public static Date dateStrConvertDate(String time) {
		SimpleDateFormat df = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
		try {
...
//		if (hour < 10) {
//			return cn.com.dhcc.di.platform.common.utils.DateUtils.getCurrentTime() + " 0" + hour;
//		}
//		return cn.com.dhcc.di.platform.common.utils.DateUtils.getDateByString() + " " + hour;
//	}
...
//			if (hour < 10) {
//				return cn.com.dhcc.di.platform.common.utils.DateUtils.getDateByString() + " 0" + hour;
//			}
//			return cn.com.dhcc.di.platform.common.utils.DateUtils.getDateByString() + " " + hour;
//		}
//		// 获取当前日期前一天
//		return cn.com.dhcc.di.platform.common.utils.DateUtils.getBeforeDay() + " " + 23;
//	}
	...
	/**
	 * 获取今年月份数据 说明 有的需求前端需要根据月份查询每月数据，此时后台给前端返回今年共有多少月份
	 *
	...
	/**
	 * 返回当前年度季度list 本年度截止目前共三个季度，然后根据1,2,3分别查询相关起止时间
	 * 
	 * @return [1, 2, 3]
	 */
